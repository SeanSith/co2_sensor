...
def get_battery_voltage():
    ...
    # This formula should show the nominal 3.7V max capacity (approximately) when 5V is present and the
    # VBAT is in charge state for a 1S LiPo battery with a max capacity of 3.7V
    global vbat_voltage
